...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react-router-dom"), require("react-dom/server"), require("react"), require("react-addons-css-transition-group"), require("mobx-react"), require("prop-types"), require("mobx"), require("antd-mobile"));
	else if(typeof define === 'function' && define.amd)
		define(["react-router-dom", "react-dom/server", "react", "react-addons-css-transition-group", "mobx-react", "prop-types", "mobx", "antd-mobile"], factory);
...
exports.default = (() => {
	var _ref = _asyncToGenerator(function* (config) {
		...
		let Fade = (0, _mobxReact.observer)(_class = class Fade extends _react.Component {
			...
			isLogin() {
				...
				return _asyncToGenerator(function* () {
					const status = yield $store.auth.check();
					const { pathname } = _this2.props.location;
					const isAuth = ['/', '/register', '/forgetPwd'].indexOf(pathname) === -1;
					const next = $utils.isFunction(config.enter) ? config.enter.bind(true, _this2.props) : _this2.props.history.push;
					if (status) {
		...
		let Home = (_temp = _class2 = class Home extends _react.Component {
			getChildContext() {
				return { $store, $utils };
			}
			render() {
...
const checkTel = exports.checkTel = tel => {
	let ret = false;
	if (!tel) {
...
let store = (_class = class store {
	...
	initializer: function () {
		return (() => {
			var _ref = _asyncToGenerator(function* (param) {
				...
				const result = yield utils.clientCall('/api/list', param);
	...
	initializer: function () {
		return (() => {
			var _ref2 = _asyncToGenerator(function* (param) {
				const res = yield utils.clientCall('/api/detail', param);
	...
	initializer: function () {
		return (() => {
			var _ref3 = _asyncToGenerator(function* (param) {
				const res = yield utils.clientCall('/api/index');
				return res.success ? res.data : null;
			});
	...
	initializer: function () {
		return _asyncToGenerator(function* () {
			const res = yield utils.clientCall('/api/query/account');
	...
	initializer: function () {
		return _asyncToGenerator(function* () {
			const res = yield utils.clientCall('/api/query/userDetail');
...
let store = (_class = class store {
	...
	initializer: function () {
		...
		return _asyncToGenerator(function* () {
			...
			const result = yield utils.clientCall('/api/loginStatus');
	...
	initializer: function () {
		...
		return (() => {
			var _ref2 = _asyncToGenerator(function* (params) {
				const res = yield utils.clientCall('/api/login', params);
	...
	initializer: function () {
		...
		return (() => {
			var _ref3 = _asyncToGenerator(function* (params) {
				const res = yield utils.clientCall('/api/loginout', params);
	...
	initializer: function () {
		return (() => {
			var _ref4 = _asyncToGenerator(function* (params) {
				const res = yield utils.clientCall('/api/sendCode', params);
				return res;
			});
	...
	initializer: function () {
		return (() => {
			var _ref5 = _asyncToGenerator(function* (params) {
				return yield utils.clientCall('/api/sendRegisterCode', params);
			});
	...
	initializer: function () {
		return (() => {
			var _ref6 = _asyncToGenerator(function* (params) {
				return yield utils.clientCall('/api/register', params);
			});
	...
	initializer: function () {
		return (() => {
			var _ref7 = _asyncToGenerator(function* (params) {
				return yield utils.clientCall('/api/forget', params);
			});
